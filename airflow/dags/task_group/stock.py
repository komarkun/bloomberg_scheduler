...
from tasks.ingestion.stock.bloomberg_data_pipeline import (
    fetch_bloomberg_stock_data,
    refame_stock_dataframe,
)
from tasks.qc.stock.bloomberg_data_pipeline import check_stock_data
...
def create_stock_task_group(group_id):
